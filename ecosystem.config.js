  ...
  apps : [
      {
        ...
        env: {
            'PORT': 8888,
            'MONGO_URL':  'mongodb+srv://feiraappadm:feiraappadm@feira-app.90cyd.mongodb.net/dev?retryWrites=true&w=majority',
        ...
        env_production: {
          'PORT': 3000,
          'MONGO_URL':  'mongodb+srv://feiraappadm:feiraappadm@feira-app.90cyd.mongodb.net/app?retryWrites=true&w=majority',
